...
${PBJS_BIN} -t static-module -w commonjs -o ${OUT_DIR}/${OUT_DAM_FILE}.js ${TMP_PROTO_FILE} ${SRC_COMMON_PROTO_FILE} ${SRC_COMMON_OAUTHCLIENT_PROTO_FILE} ${SRC_COMMON_ACCOUNT_PROTO_FILE}
