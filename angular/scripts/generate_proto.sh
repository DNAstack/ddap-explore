...
COMMON_OAUTHCLIENT_PROTO_FILE=../shared/protos/proto/common/v1/oauthclient.proto
...
${PBJS_BIN} -t static-module -w commonjs -o ${OUT_DIR}/${OUT_DAM_FILE}.js ${TMP_PROTO_FILE} ${COMMON_PROTO_FILE} ${COMMON_OAUTHCLIENT_PROTO_FILE}
${PBTS_BIN} -o ${OUT_DIR}/${OUT_DAM_FILE}.d.ts ${OUT_DIR}/${OUT_DAM_FILE}.js

# IC
cp ${SRC_IC_PROTO_FILE} ${TMP_PROTO_FILE}

${PBJS_BIN} -t static-module -w commonjs -o ${OUT_DIR}/${OUT_IC_FILE}.js ${TMP_PROTO_FILE} ${COMMON_PROTO_FILE} ${COMMON_OAUTHCLIENT_PROTO_FILE}
