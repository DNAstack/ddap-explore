  ...
  private registerModules() {
    ...
    this.viewController
      ...
      .registerModule({
        ...
        name: 'Genomes',
        iconName: 'sync_alt',
        routerLink: 'cloud/virus/genomes',
        group: 'virus',
        isApp: false,
        isExperimental: true,
        expFlag: 'demo',
      ...
      .registerModule({
        ...
        routerLink: 'cloud/virus/variants',
        group: 'virus',
        isApp: false,
        isExperimental: true,
        expFlag: 'demo',
      ...
      .registerModule({
        ...
        name: 'Molecules',
        iconName: 'gesture',
        routerLink: 'cloud/virus/molecules',
        group: 'virus',
        isApp: false,
        isExperimental: true,
        expFlag: 'demo',
